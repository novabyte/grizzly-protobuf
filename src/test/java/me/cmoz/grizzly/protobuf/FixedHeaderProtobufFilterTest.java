...
/**
 * {@link me.cmoz.grizzly.protobuf.FixedHeaderProtobufFilter}.
 */
public class FixedHeaderProtobufFilterTest {
    ...
    public void filterMessageTest()
        ...
        final FilterChainBuilder serverFilterBuilder = FilterChainBuilder.stateless()
                ...
                .add(new FixedHeaderProtobufFilter(user.getDefaultInstanceForType()))
